...
#define MAX_SERVERS_THREE 200    /* number of servers              */
#define SERVERS_THREE_F1 6
#define SERVERS_THREE_F2 4
...
} event_list_three[MAX_SERVERS_THREE + 1];
